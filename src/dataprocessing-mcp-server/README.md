...
* Commons: Enables users to create and manage usage profiles and security configurations, which provide users with the ability to manage the resource types and encryption of their ETL jobs and sessions.
...
```
{
  "mcpServers": {
    "aws.dataprocessing-mcp-server": {
      ...
      "command": "uvx",
      "args": [
        "aws.dataprocessing-mcp-server@latest",
        "--allow-write"
      ],
      "env": {
...
```
{
  "mcpServers": {
    "aws.dataprocessing-mcp-server": {
      "command": "uvx",
      "args": ["aws.dataprocessing-mcp-server@latest"],
      "env": {
        "FASTMCP_LOG_LEVEL": "ERROR"
      },
      "autoApprove": [],
...
#### `awslabs.dataprocessing-mcp-server@latest` (required)
