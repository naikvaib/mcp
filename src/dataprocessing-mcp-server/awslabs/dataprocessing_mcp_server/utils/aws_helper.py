...
class AwsHelper:
    ...
    # Class variable to cache the AWS account ID
    ...
    def create_boto3_client(cls, service_name: str, region_name: Optional[str] = None) -> Any:
        ...
        The client is configured with a custom user agent suffix 'awslabs/mcp/dataprocessing-mcp-server/0.1.0'
        ...
        config = Config(user_agent_extra='awslabs/mcp/dataprocessing-mcp-server/0.1.0')
