...
class DataCatalogManager:
    ...
    async def delete_connection(
        ...
        try:
            ...
            try:
                response = self.glue_client.get_connection(**get_kwargs)
                ...
                if not AwsHelper.is_resource_mcp_managed(
                    self.glue_client, connection_arn, parameters
                ):
    ...
    async def update_connection(
        ...
        try:
            ...
            try:
                ...
                if 'Parameters' in connection_input:
                    ...
                    connection_input['Parameters'] = parameters
    ...
    async def delete_partition(
        ...
        try:
            ...
            try:
                ...
                region = AwsHelper.get_aws_region() or 'us-east-1'
                account_id = catalog_id or AwsHelper.get_aws_account_id()
                partition_arn = f'arn:aws:glue:{region}:{account_id}:partition/{database_name}/{table_name}/{"/".join(partition_values)}'
    ...
    async def delete_catalog(self, ctx: Context, catalog_id: str) -> DeleteCatalogResponse:
        ...
        try:
            ...
            try:
                ...
                catalog_arn = f'arn:aws:glue:{region}:{account_id}:catalog/{catalog_id}'
