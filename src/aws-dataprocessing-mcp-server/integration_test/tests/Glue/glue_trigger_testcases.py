...
def glue_triggers_test_cases(s3_bucket, glue_role, aws_clients) -> List[MCPTestCase]:
    ...
    return [
        ...
        MCPTestCase(
            ...
            input_params={
                ...
                'trigger_definition': {
                    ...
                    'Actions': [
                        {'JobName': 'mcp-test-job-basic', 'Arguments': {'--key1': 'value1'}}
                    ],
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'get-trigger', 'trigger_name': 'mcp_test_trigger'},
            dependencies=['create_glue_trigger_basic'],
            validators=[ContainsTextValidator('Successfully retrieved trigger')],
            clean_ups=[],
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'get-trigger', 'trigger_name': 'non_existent_trigger'},
            dependencies=[],
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'start-trigger', 'trigger_name': 'mcp_test_trigger'},
            dependencies=['create_glue_trigger_basic'],
            validators=[
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'start-trigger'},
            dependencies=[],
            validators=[
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'stop-trigger', 'trigger_name': 'non_existent_trigger'},
            dependencies=[],
            validators=[ContainsTextValidator('not found')],
            clean_ups=[],
        ),
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'stop-trigger'},
            dependencies=[],
            validators=[
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'delete-trigger', 'trigger_name': 'non_existent_trigger'},
            dependencies=[],
            validators=[ContainsTextValidator('not found')],
            clean_ups=[],
        ),
        MCPTestCase(
            ...
            tool_name='manage_aws_glue_triggers',
            input_params={'operation': 'delete-trigger'},
            dependencies=[],
            validators=[
