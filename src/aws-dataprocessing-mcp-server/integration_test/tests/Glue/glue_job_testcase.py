...
from data_processing_mcp_server_tests.core.aws_setup import upload_script, create_non_mcp_job
    ...
    return [
        ...
        MCPTestCase(
            ...
            input_params={
                ...
                "job_definition": {
                    "Role": glue_role,
                    "Description": "UPDATED Should Fail"
                }
            },
            aws_resources=[lambda: create_non_mcp_job("non-mcp-test-job")],
            dependencies=[],
            validators=[
                ContainsTextValidator("missing required tags")
            ]
        ),
        ...
        MCPTestCase(
            ...
            input_params={
                "operation": "delete-job",
                "job_name": "job-name-does-not-exist"
            },
            dependencies=[],
            validators=[
        ...
        MCPTestCase(
            ...
            dependencies=["create_glue_job_basic"],
            validators=[
                ContainsTextValidator("Successfully retrieved job")
            ],
            clean_ups=[]
        ),
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Error executing tool manage_aws_glue_jobs: job_name is required for get-job operation")
            ],
            clean_ups=[]
        ),
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator("Successfully retrieved jobs", expected_count=2) # 2 created job
            ],
            clean_ups=[]
        ),
        ...
        MCPTestCase(
            ...
            dependencies=["create_glue_job_basic"],
            validators=[
                ContainsTextValidator("Successfully started job run")
            ],
            clean_ups=[
                DeleteAWSResources(
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Error executing tool manage_aws_glue_jobs: job_name is required"),
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Error executing tool manage_aws_glue_jobs: job_name and job_run_id are required for get-job-run operation")
            ],
            clean_ups=[]
        ),
        ...
        MCPTestCase( 
            ...
            validators=[
                ContainsTextValidator("Successfully retrieved job runs")  
            ],
            clean_ups=[]
        ),
        ...
        MCPTestCase(
            ...
            dependencies=["start_job_run_basic"],
            validators=[
                ContainsTextValidator("Successfully stopped job run")
            ],
            clean_ups=[]
        ),
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Error executing tool manage_aws_glue_jobs: job_name and job_run_id are required for stop-job-run operation")
            ],
            clean_ups=[]
        ),
