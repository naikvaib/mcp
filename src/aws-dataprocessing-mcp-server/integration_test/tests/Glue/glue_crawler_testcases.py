...
def glue_crawlers_test_cases(s3_bucket, glue_role, aws_clients) -> List[MCPTestCase]:
    return [
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator("Successfully retrieved crawler")
            ],
            clean_ups=[]
        ),
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("crawler_name and crawler_definition are required for create-crawler operation")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            input_params={
                "operation": "delete-crawler",
                "crawler_name": "non_existent_crawler"
            },
            dependencies=[],
            validators=[
                ContainsTextValidator("Cannot delete crawler non_existent_crawler")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            input_params={
                ...
                "crawler_definition": {
                    ...
                    "Targets": {
                        "S3Targets": [
                            {
                                "Path": f"s3://{s3_bucket}/crawlers-updated/"
                            }
                        ]
                    },
            ...
            validators=[
                ...
                AWSBotoValidator(
                    ...
                    operation="get_crawler",
                    operation_input_params={"Name": "mcp_test_crawler"},
                    expected_keys=["crawler_name", "crawler_definition.DatabaseName", "crawler_definition.Targets"]
                )
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("crawler_name and crawler_definition are required for update-crawler operation")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Successfully listed crawlers")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            validators=[
                ...
                AWSBotoValidator(
                    ...
                    expected_keys=["crawler_name", "crawler_definition.DatabaseName", "crawler_definition.Schedule"]
                )
            ],
            clean_ups=[
                DeleteAWSResources(
