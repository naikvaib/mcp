...
def glue_partitions_test_cases(s3_bucket, aws_clients) -> List[MCPTestCase]:
    return [    
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator("Successfully retrieved partition")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("partition_values and partition_input are required for create-partition operation")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            dependencies=["create_partition_basic"],
            validators=[
                ContainsTextValidator("Successfully listed", expected_count=1)
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("partition_values and partition_input are required for update-partition operation")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
