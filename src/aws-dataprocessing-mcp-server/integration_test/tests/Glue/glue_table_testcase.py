...
def glue_table_test_cases(s3_bucket, aws_clients) -> List[MCPTestCase]:
        ...
        MCPTestCase(
            ...
            validators=[
                ...
                AWSBotoValidator(
                    ...
                    expected_keys=["Description","StorageDescriptor.Columns","StorageDescriptor.Location","StorageDescriptor.InputFormat","StorageDescriptor.OutputFormat","StorageDescriptor.SerdeInfo"],
                )
            ],
    ...
    MCPTestCase(
        ...
        dependencies=[],
        validators=[
            ContainsTextValidator("Entity Not Found")
        ],
        clean_ups=[]
    ),
    MCPTestCase(
