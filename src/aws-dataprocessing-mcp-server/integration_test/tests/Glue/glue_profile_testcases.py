...
def glue_profiles_test_cases(aws_clients) -> List[MCPTestCase]:
    return [
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Successfully created usage profile mcp_test_profile_no_check"),
                AWSBotoValidator(
                    boto_client=aws_clients["glue"],
                    operation="get_usage_profile",
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator("Successfully retrieved usage profile")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            input_params={
                ...
                "configuration": {
                    "SessionConfiguration": {
                        "Timeout": {"DefaultValue": "600"}
                    },
                    "JobConfiguration": {
                        "MaxRetries": {"DefaultValue": "5"}    
                    }
                }
            },
            dependencies=["create_glue_profile_not_check_configuration"],
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Usage profile non_existent_profile not found")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
