...
def load_all_grouped_test_cases(s3_bucket, glue_role, aws_clients) -> List[Tuple[str, List[MCPTestCase]]]:
    ...
    grouped_functions = OrderedDict([
        ("glue_jobs", glue_job_test_cases(s3_bucket, glue_role, aws_clients)+ glue_triggers_test_cases(s3_bucket, glue_role, aws_clients)+ glue_workflows_test_cases(aws_clients)),
        ("glue_database_table", glue_database_test_cases(s3_bucket, aws_clients)+glue_table_test_cases(s3_bucket, aws_clients)+glue_partitions_test_cases(s3_bucket, aws_clients)),
        ("glue_connections", glue_connections_test_cases(aws_clients)),
        ("glue_catalogs", glue_catalogs_test_cases(aws_clients)),
        ("glue_crawlers", glue_crawlers_test_cases(s3_bucket, glue_role, aws_clients)+glue_crawler_management_test_cases(aws_clients)),
        ...
        ("emr", emr_cluster_test_cases(aws_clients)+ emr_step_test_cases(s3_bucket, aws_clients)+ emr_instance_test_cases(aws_clients)),
        ("athena_query", athena_named_query_test_cases(aws_clients)+athena_query_execution_test_cases(s3_bucket, aws_clients)),
        ("athena_data_catalog_db_table", athena_data_catalog_test_cases(aws_clients)+athena_databse_table_test_cases(s3_bucket, aws_clients)),
