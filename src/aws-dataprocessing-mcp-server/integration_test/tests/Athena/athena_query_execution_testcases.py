...
def athena_query_execution_test_cases(s3_bucket,aws_clients) -> List[MCPTestCase]:
    return [
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator("Successfully started query execution")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            input_params={
                ...
                "query_execution_ids": ["{{start_athena_query_execution.result.content[0].text.query_execution_id}}"]
            },
            dependencies=["start_athena_query_execution"],
            validators=[
                ContainsTextValidator("Successfully retrieved query executions")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=["start_athena_query_execution"],
            validators=[
                ContainsTextValidator("Successfully retrieved query execution")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("query_execution_id is required for get-query-execution operation")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=["start_athena_query_execution"],
            validators=[
                ContainsTextValidator("Query has not yet finished.")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=[],
            validators=[  
                ContainsTextValidator("query_execution_id is required for get-query-results operation")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("query_execution_id is required for get-query-runtime-statistics operation")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=["start_athena_query_execution"],
            validators=[
                ContainsTextValidator("Successfully listed query executions")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=["start_athena_query_execution"],
            validators=[
                ContainsTextValidator("Successfully stopped query execution")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("query_execution_id is required for stop-query-execution operation")
            ],
            clean_ups=[]
        )
