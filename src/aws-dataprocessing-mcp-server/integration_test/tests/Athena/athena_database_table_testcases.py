...
def athena_databse_table_test_cases(s3_bucket, aws_clients) -> List[MCPTestCase]:
    return [
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator("Successfully retrieved metadata")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[
                ContainsTextValidator("Successfully listed databases")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
            ...
            dependencies=["create_database_basic"],
            validators=[
                ContainsTextValidator("Successfully listed table metadata")
            ],
            clean_ups=[]
        ),
        MCPTestCase(
