...
def emr_cluster_test_cases(aws_clients) -> List[MCPTestCase]:
    ...
    return [
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_emr_clusters',
            input_params={'operation': 'list-clusters', 'max_results': 10},
            dependencies=['create_emr_cluster_basic'],
            validators=[ContainsTextValidator('Successfully listed EMR clusters')],
            clean_ups=[],
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            dependencies=['create_emr_cluster_basic'],
            validators=[ContainsTextValidator('Successfully described EMR cluster')],
            clean_ups=[],
        ),
        MCPTestCase(
            test_name='describe_emr_cluster_missing_id',
            tool_name='manage_aws_emr_clusters',
            input_params={'operation': 'describe-cluster'},
            dependencies=[],
            validators=[
        ...
        MCPTestCase(
            ...
            tool_name='manage_aws_emr_clusters',
            input_params={'operation': 'modify-cluster', 'name': 'mcp-test-emr-cluster-modified'},
            dependencies=[],
            validators=[
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator(
                    'Successfully initiated termination for 1 MCP-managed EMR clusters'
                )
            ],
            clean_ups=[],
        ),
        MCPTestCase(
            ...
            tool_name='manage_aws_emr_clusters',
            input_params={'operation': 'terminate-clusters'},
            dependencies=[],
            validators=[
