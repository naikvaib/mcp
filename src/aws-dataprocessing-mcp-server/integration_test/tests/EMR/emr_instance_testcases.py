...
def emr_instance_test_cases(aws_clients) -> List[MCPTestCase]:
    ...
    return [
        MCPTestCase(
            ...
            validators=[
                ...
                AWSBotoValidator(
                    ...
                    injectable_params={
                        'cluster_id': '{{create_cluster_with_fleet.result.content[0].text.cluster_id}}'
                    },
                ),
            ],
            clean_ups=[
        ...
        MCPTestCase(
            ...
            dependencies=[],
            validators=[ContainsTextValidator('cluster_id and instance_fleet are required')],
            clean_ups=[],
        ),
        MCPTestCase(
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator(
                    'cluster_id, instance_fleet_id, and instance_fleet_config are required'
                )
            ],
            clean_ups=[],
        ),
        MCPTestCase(
            ...
            input_params={
                ...
                'instance_group': {'InstanceCount': 3, 'InstanceType': 'm5.xlarge'},
            },
            dependencies=[],
            validators=[
                ContainsTextValidator(
        ...
        MCPTestCase(
            ...
            validators=[
                ContainsTextValidator(
                    'Successfully listed instance fleets for EMR cluster', expected_count=3
                )  # 1 master, 1 core, 1 task
            ],
            clean_ups=[],
        ),
        MCPTestCase(
