...
class GlueCommonsHandler:
    ...
    def __init__(
        ...
        self.mcp.tool(name="manage_aws_glue_usage_profiles")(
            self.manage_aws_glue_usage_profiles
        )
        ...
        try:
            ...
            if operation == "create-profile":
                if configuration is None:
                    raise ValueError(
                        "configuration is required for create-profile operation"
                    )
                ...
                if configuration is None:
                    raise ValueError(
                        "configuration is required for update-profile operation"
                    )
        ...
        try:
            ...
            if operation == "create-security-configuration":
                ...
                try:
                    ...
                    if e.response["Error"]["Code"] == "EntityNotFoundException":
                        error_message = (
                            f"Security configuration {config_name} not found"
                        )
                        log_with_request_id(ctx, LogLevel.ERROR, error_message)
                        return DeleteSecurityConfigurationResponse(
                            isError=True,
                ...
                return GetSecurityConfigurationResponse(
                    ...
                    encryption_configuration=security_config.get(
        ...
        try:
            ...
            if operation == "get-catalog-encryption-settings":
                ...
                return GetDataCatalogEncryptionSettingsResponse(
                    ...
                    encryption_settings=response.get(
    ...
    async def manage_aws_glue_resource_policies(
        ...
        try:
            ...
            if operation == "get-resource-policy":
                ...
                if policy is None:
                    raise ValueError(
                        "policy is required for put-resource-policy operation"
                    )
                ...
                return PutResourcePolicyResponse(
                    ...
                    content=[
                        TextContent(
                            type="text", text="Successfully updated resource policy"
                        )
                    ],
                    policy_hash=response.get("PolicyHash"),
                    operation="put",
                ...
                return DeleteResourcePolicyResponse(
                    ...
                    content=[
                        TextContent(
                            type="text", text="Successfully deleted resource policy"
                        )
                    ],
                    operation="delete",
                )
