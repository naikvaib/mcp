...
class AWSSetup:
    ...
    def setup_test_role(self, role_name_prefix: str, policies: Optional[List[str]] = None) -> Tuple[str, str]:
    ...
    def _find_existing_role(self, role_name_prefix: str, policies: List[str]) -> Optional[Tuple[str, str]]:
    ...
    def wait_for_job_run_completion(self, job_name: str, run_id: str, 
                                   timeout_seconds: int = 300, 
                                   check_interval_seconds: int = 10) -> Dict[str, Any]:
